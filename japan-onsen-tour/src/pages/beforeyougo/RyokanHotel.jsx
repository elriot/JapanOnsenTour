...
<CompareTable data={compareData} />
	return (
		<Section className={`${className} page-content-text`}>
			...
			<ResponsiveRow>
				<ResponsiveRowImage src={ryokanImg} alt="ryokan room" rounded="true" sourceText="ryokan.co.jp"></ResponsiveRowImage>
				<ResponsiveRowImage src={kaisekiImg} alt="kaiseki dinner" rounded="true" sourceText="ryokan.co.jp"></ResponsiveRowImage>
			</ResponsiveRow>

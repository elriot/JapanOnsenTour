...
function DropdownMenu({ items, onLinkClick, menuWidth=60, className="" }) {
	return (
		...
		<div className={`w-50 z-10 font-normal border-1 border-gray-300 bg-white divide-y divide-gray-100 rounded-lg shadow-sm bg-gray-300 divide-gray-600 absolute mt-1`}>

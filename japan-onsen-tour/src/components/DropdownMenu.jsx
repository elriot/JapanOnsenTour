...
function DropdownMenu({ items, onLinkClick, width=60, className="" }) {
	return (
		...
		<div className={`z-10 font-normal border-1 border-gray-300 bg-white divide-y divide-gray-100 rounded-lg shadow-sm w-${width} bg-gray-300 divide-gray-600 absolute mt-1`}>
